...
python3 train_policy.py 'pm' --exp_name P2_h5_ff --history 5 -lr 5e-4 --discount 0.9 -s 90
...
python3 train_policy.py 'pm' --exp_name P2_h5_rec --history 5 -lr 5e-4 --discount 0.9 -rec